...
namespace DesignPatterns.Behavioral.Visitor.CodeExercise
{
    ...
    class CodeExercise
    {
        ...
        {
            var simple = new AdditionExpression(new Value(2), new MultiplicationExpression(new Value(4),new Value(8)));
